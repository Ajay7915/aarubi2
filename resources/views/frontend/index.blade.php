...
<div class="slider-area slider-layout2">
            ...
            <div class="slider-content s-tb slide-1">
                <div class="text-left title-container s-tb-c">
                    <div class="container">
                        ...
                        <div class="slider-paragraph text-light">Pellentesque habitant morbi tristique senectus et netus
                            pellente
                            morbi tristique senectneolitics ellentesque vestibulum. nectneolitics ellentesque
                            vestibulum.</div>
    ...
    <div class="slider-box-form">
        <div class="about-box-layout3">
            ...
            <form class="contact-form-box" id="contact-form-3" action="{{ route('message') }}" method="POST">
                @csrf
                @if ($errors->any())
                ...
                <div class="row">
                    ...
                    <div class="col-12 form-group">
                        <button type="submit" class="fw-btn-fill bg-Primary text-textprimary">SUBMIT NOW<i
...
<section class="project-wrap-layout3">
    <div class="project-box-layout3">
        ...
        <div class="rc-carousel nav-control-layout2" data-loop="true" data-center="true" data-items="10"
            data-margin="50" data-autoplay="false" data-autoplay-timeout="3000" data-smart-speed="1000"
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-3 d-flex justify-content-lg-end justify-content-center">
                <div class="action-box-layout1">
                    <a href="#" class="btn-fill-xl box-shadow bg-textprimary text-accent">GET A QUOTE<i
...
<section class="progress-wrap-layout2  parallax-window" data-parallax="scroll"
    data-image-src="{{ asset('frontend/img/figure/banner-bg.jpg') }}">
    <div class="container">
        <div class="row">
        ...
        <div class="rc-carousel dot-control-layout1" data-loop="true" data-items="10" data-margin="30"
            ...
            <div class="testimonial-box-layout1 bg-textprimary">
                <div class="media media-none--xs">
                    <div class="item-img">
                        <img src="{{ asset('frontendimg/figure/testimonial.jpg') }}" class="media-img-auto"
                            alt="feedback">
                    </div>
            ...
            <div class="testimonial-box-layout1 bg-textprimary">
                <div class="media media-none--xs">
                    <div class="item-img">
                        <img src="{{ asset('frontend/img/figure/testimonial1.jpg') }}" class="media-img-auto"
                            alt="feedback">
                    </div>
                    <div class="media-body">
            ...
            <div class="testimonial-box-layout1 bg-textprimary">
                <div class="media media-none--xs">
                    <div class="item-img">
                        <img src="{{ asset('frontend/img/figure/testimonial.jpg') }}" class="media-img-auto"
                            alt="feedback">
                    </div>
                    <div class="media-body">
                        <h3 class="item-title">Mark Steven</h3>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                <div class="blog-box-layout3">
                    <div class="item-img">
                        <a href="single-blog1.html"><img src="{{ asset('frontend/img/blog/blog5.jpg') }}"
                                alt="blog"></a>
                        <div class="top-item">
                            <div class="item-date">
                    ...
                    <div class="item-content">
                        <h3 class="item-title"><a href="single-blog1.html">Many important area brands given search
                                2019</a></h3>
                        <ul class="entry-meta">
                            <li>by <a href="#">Lucas Adrone</a></li>
                            <li>Comments: 0</li>
                        </ul>
                        <p>Borem ipsum dolor sit amet consec aretur adipiscing incididunt dolore.Borem ipsum dolor sit
                            amet consec.</p>
                    </div>
                </div>
            </div>
